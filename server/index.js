...
const { showAvailableScooters, rentScooter, showRentedScooters, returnScooter } = require("./scootersList");
...
app.get("/rent_scooters",       async (req, res) => { showRentedScooters(pool,req,res) });

app.post("/api/rent",           (req, res) => { rentScooter(pool,req,res) })
app.post("/api/return",         (req, res) => { returnScooter(pool,req,res) })
